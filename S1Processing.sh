...
# Get image footprint
# gdal_footprint ./logarithmic6.data/Sigma0_VV_db.img ${model_input_folder}/1/footprint.geojson

# Select bathy raster
long=$(cat ../model_input/1/footprint.geojson | jq -r .features[0].geometry.coordinates[0][0][0][0])
lat=$(cat ../model_input/1/footprint.geojson | jq -r .features[0].geometry.coordinates[0][0][0][1])
